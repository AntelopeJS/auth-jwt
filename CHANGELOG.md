...
[compare changes](https://github.com/AntelopeJS/auth/compare/v1.0.2...v1.0.3)

### 🩹 Fixes

- **deps:** Support canonical auth interface packages ([#18](https://github.com/AntelopeJS/auth/pull/18))
